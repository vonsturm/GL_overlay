 ...
 * Compilation:  g++ $(root-config --cflags) overlay.cxx -o overlay_2nbb $(root-config --libs)
 */
...
int main( int argc, char * argv[] )
{
    ...
    TFile * f_gerda_2 = new TFile( fn_gerda_2.c_str(), "READ" );;
    ...
    cout << "\tPrim2 edep: " << NumberOfPrimariesEdep_g2e << endl;
    ...
    gerda_AC -> Add( (TH1D*) f_gerda_2 -> Get( "M1_enrBEGe" ), 1./NumberOfPrimariesEdep_g2e );
    gerda_AC -> Add( (TH1D*) f_gerda_2 -> Get( "M1_enrCoax" ), 1./NumberOfPrimariesEdep_g2e );
